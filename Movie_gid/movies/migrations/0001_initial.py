# Generated by Django 3.0.4 on 2020-03-17 17:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(default=0, verbose_name='Возраст')),
                ('description', models.TextField(verbose_name='Описание')),
                ('image', models.ImageField(upload_to='FilmDirectors/', verbose_name='Изображение')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='указывать сумму в долларах', verbose_name='Бюдет')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.FilmDirector', verbose_name='режиссер')),
